...
* @author wikim(unange@yuhan.ac.kr)
* date 2026.04.28
...
private:
	...
	/// <returns>인수의 문제 있다면 FALSE, 없다면 TRUE</returns>
...
public:
	...
	///파일 포인터를 무조건, 현재 위치와 상관없이 처음으로 보낸다.
